...
//			      i_position == 0 ? 1000000 : r_off);
//	    sim.stampResistor(0, nodes[nSwitch1+p],
//		      i_position == 0 ? 1000000000 : 100000);
...
//			      i_position == 1 ? r_on : r_off);
		...
		sim.stampResistor(0, nodes[nSwitch2+p],r_off);
	    }
	    else
	    {
		sim.stampResistor(0, nodes[nSwitch1+p],r_off);
