...
//	if (editDialog != null && editDialog.elm instance of CircuitElm)
...
//	cv.repaint();
    ...
    void ShowMatrix(){
	GWT.log(circuitMatrix.toString());
    }
...
//		    converged = false;
		...
		if (printit) {
		    ...
		    console("done circuitMatrix");
		    for(i=0; i!= circuitMatrixSize;i++){
			String y="";
			 y += circuitRightSide[i] + ",";
			 console(y);
		    }
		    console("done circuitRightSide");
		    for(i=0; i!= circuitMatrixSize;i++){
			String y="";
			 y += circuitPermute[i] + ",";
			 console(y);
		    }
		    console("done circuitPermute");
		}
		if (circuitNonLinear) {
...
//    public void keyReleased(KeyEvent e) {}
	...
	switch (tint) {
    	...
    	case 'E': return new ECUElm(x1, y1, x2, y2, f,st);
