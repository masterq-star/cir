...
class CkpSquare extends VoltageElm{
    ...
    public CkpSquare(int xx, int yy) { super(xx, yy, WF_AC);
   createSlider();
    }
                public CkpSquare(int xa, int ya, int xb, int yb, int f,
            	       StringTokenizer st) {
