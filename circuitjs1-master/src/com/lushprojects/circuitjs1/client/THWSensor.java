...
class THWSensor extends CircuitElm {
	double resistance;
	Scrollbar slider;
	Label label;
	public THWSensor(int xx, int yy) { super(xx, yy); resistance = 1; createSlider();}
	public THWSensor(int xa, int ya, int xb, int yb, int f,
		    StringTokenizer st) {
	    super(xa, ya, xb, yb, f);
	    createSlider();
